...
import { useUpdateOffer, useOffer } from "@/hooks/query/offer.hook";
...
export function EditOfferForm({ offerId }: EditOfferFormProps) {
  ...
  const onSubmit = (data: OfferFormData) => {
    updateOffer(
      { id: offerId, data },
      {
        onSuccess: () => router.push("/offer"),
      }
    );
  };

  if (isLoading) {
    return <LoadingState message="Loading offer data..." size="lg" />;
  }
