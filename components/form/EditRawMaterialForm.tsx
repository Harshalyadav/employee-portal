...
import { useEditRawMaterial } from "@/hooks";
import {
...
interface EditRawMaterialFormProps {
  defaultValues: EditRawMaterialSchema;
  onSuccess?: () => void;
}

export function EditRawMaterialForm({
  defaultValues,
  onSuccess,
}: EditRawMaterialFormProps) {
  const router = useRouter();
  const { mutate: editRawMaterial, isPending } = useEditRawMaterial();
  ...
  const onSubmit = (data: EditRawMaterialSchema) => {
